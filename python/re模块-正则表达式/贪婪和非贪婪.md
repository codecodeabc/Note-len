...
>>> r.group(1)
# .+  配置了 This is a number 23 ，所以(\d+-\d+-\d+-\d+)只能匹配 '4-235-22-423'
'4-235-22-423'
>>> r=re.match(".+?(\d+-\d+-\d+-\d+)",s)
>>> r.group(1)
'234-235-22-423'
...
![image-20210902112911342](https://raw.githubusercontent.com/codecodeabc/Note-len/main/img/20210902112911.png)
