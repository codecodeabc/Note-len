...
输出结果：
复制代码pool-1-thread-2 运动员等待裁判员响哨！！！
...
![CyclicBarrier执行示意图.jpg](https://raw.githubusercontent.com/codecodeabc/Note-len/main/img/202111081943183.webp)CyclicBarrier执行示意图.jpg
...
//用于查询阻塞等待的线程是否被中断
boolean isBroken()
复制代码//将屏障重置为初始状态。如果当前有线程正在临界点等待的话，将抛出BrokenBarrierException。
void reset()
```
